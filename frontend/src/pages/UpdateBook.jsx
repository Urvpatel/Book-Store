    ...
    const submit = async (e) => {
        try {
            if (
                ...
                Data.desc === "" ||
                Data.language === "" ||
                Data.quantity === "" // Check if quantity is filled
            ) {
                ...
                setData({
                    ...
                    desc: "",
                    language: "",
                    quantity: "", // Reset quantity after submission
                });
    ...
    return (
        <div className='h-[100%] p-0 md:p-4 bg-zinc-900'>
            ...
            <div className='p-4 bg-zinc-800 rounded'>
                ...
                <div className='mt-4'>
                    <label htmlFor="" className='text-zinc-400'>Quantity</label> {/* New quantity field */}
